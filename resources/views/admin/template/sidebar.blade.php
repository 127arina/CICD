<div class="sidebar">
    ...
    <nav class="mt-2">
        ...
        <li class="nav-item">
            <a href="{{ route('admin.requestpelanggan.index') }}"
                class="nav-link {{ request()->routeIs('admin.requestpelanggan.index') ? 'active' : '' }}">
                <i class="nav-icon fas fa-user"></i>
                <p>Permintaan member</p>
            </a>
        </li>
            <li class="nav-item">
            ...
            {{-- <li class="nav-item">
                <a href="{{ route('admin.pesanan.list') }}"
                    class="nav-link {{ request()->routeIs('admin.pesanan.list') ? 'active' : '' }}">
                    <i class="nav-icon fas fa-file-alt"></i>
                    <p>Pesanan</p>
                </a>
            </li> --}}
            ...
            <li class="nav-item">
                <a href="{{ route('admin.toko.index') }}"
                    class="nav-link {{ request()->routeIs('admin.toko.index') ? 'active' : '' }}">
