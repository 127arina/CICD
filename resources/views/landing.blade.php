...
<head>
    ...
    <title>{{ config('rama_laundry', 'LaundryApp') }}</title>
...
<body>
        ...
        <div class="container p-5">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p> Kami menggunakan peralatan yang cukup lengkap dan canggih. Peralatan kami memungkinkan
                        baju dengan kulitas tinggi dengan jahitan serapi mungkin</p>
                </div>
                <div class="col-lg-6">
                    <img class="img-fluid d-none d-lg-block" src="{{asset('img/landing/alat_jahit.jpg')}}" alt="" srcset="">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container p-5">
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <p>Usaha Jahit kami menerima segala tipe pakaian mulai dari baju, celana, jas, gorden, bed cover,
    ...
    <section class="kelebihan bg-blue text-white">
        <div class="container p-5">
            <div class="row">
                <div class="col-lg-6">
                    <h4>Profesional</h4>
                    <p>Memiliki pengalaman yang cukup dalam bidang jahit pakaian dapat membantu Anda memahami berbagai jenis kain, alat jahit, dan teknik yang diperlukan untuk menghasilkan pakaian yang berkualitas tinggi.</p>
                </div>
                <div class="col-lg-6">
    ...
    <section class="text-center p-5">
        <h3>Apa saja yang bisa kami Jahit?</h3>
    </section>
        ...
        <div class="container p-5">
            <div class="row">
                <div class="col-md-6 mb-4 mb-sm-0">
                    <h5>Alamat</h5>
                    <p>Desa Pendarungan, kec.Kabat, Banyuwangi</p>
                    <br>
                    <h5>Kontak</h5>
                    <p>tutikhidayanti2004@gmail.com</p>
                    <p>083846946185</p>
                </div>
                <div class="col-md-6">
                    <iframe
                        src=https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3948.6475976857364!2d114.32309541478111!3d-8.238145894071865!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xdce7e280d9b0d8f1!2zOMKwMTQnMTcuMyJTIDExNMKwMTknMzEuMCJF!5e0!3m2!1sid!2sid!4v1670035487819!5m2!1sid!2sid
